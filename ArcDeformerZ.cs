...
[ExecuteInEditMode]
public class ArcDeformerZ : MonoBehaviour
{
    ...
    private void UpdateMesh()
    {
        ...
        for (int i = 0; i < segments; i++)
        {
            ...
            vertices[i * 2 + 1] = new Vector3(0, c * outerRadius, s * outerRadius) + position;
            vertices[i * 2 + 2] = new Vector3(0, c * innerRadius, s * innerRadius) + position;
